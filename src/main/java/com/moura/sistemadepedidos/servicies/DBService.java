...
import com.moura.sistemadepedidos.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "mateus51moura@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));		
		cli1.getTelefones().addAll(Arrays.asList("2427363323", "4193838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "mateysmoura@gmail.com", "82113120003", TipoCliente.PESSOAFISICA, pe.encode("123"));
		...
		enderecoReposioty.saveAll(Arrays.asList(e1, e2, e3));
